    ...
    <div className="panel">
      ...
      <div className="container-fluid panel-front">
        <div className="row">
          ...
          <div className="col vertical-align-coll">

            <div className="btn-pannel">
              <div className="row">
                <div className="col">
                  <button className="winCl-btn">Boiler</button>
                </div>
                <div className="col">
                  <button class="winCl-btn">Turbine</button>
                </div>
                <div className="col">
                  <button class="winCl-btn">FW Pump</button>
                </div>
              </div>
